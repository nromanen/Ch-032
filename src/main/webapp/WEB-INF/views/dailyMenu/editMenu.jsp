    ...
    <div class="container">
      <div class="panel panel-default">
        <div class="panel-heading">
          <button type="button" class="btn btn-default btn-xs spoiler-trigger" data-toggle="collapse">Перелік та наявність продуктів</button>
        </div>
        ...
        <div class="panel panel-default">
        <div class="panel-heading">
          <button type="button" class="btn btn-default btn-xs spoiler-trigger" data-toggle="collapse">Відповідність нормам</button>
        </div>
        <div class="panel-collapse collapse out">
          <div class="panel-body">
