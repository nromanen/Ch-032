...
<body>
	<div class="container">
		<div class="btn-group btn-group-justified">
			<p align="right">
				<a id="saveButton">
					<button type="button" class="btn btn-primary" id="saveButton go">
	...
	<div class="container">
		<form:form method="post" modelAttribute="dishForm" id="save"
			name="save" action="addcomponent" class="navbar-form navbar-left">

			<input name="addNewDish" type="hidden" value="false" />
			<div class="col-md-2">
				<h4 class="newDish">
					<spring:message code="${newdish}" />
				</h4>
			</div>
